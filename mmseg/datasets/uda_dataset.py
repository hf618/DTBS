...
class UDADataset(object):
    ...
    def get_rare_class_sample(self):
        ...
        return {
            **s1, 
            'target_day_img_metas': s2['img_metas'],
    ...
    def __getitem__(self, idx):
        if self.rcs_enabled:
            ...
            s1 = self.source[idx // len(self.target_day)]
            s2 = self.target_day[idx % len(self.target_day)]
            s3 = self.target_night[idx % len(self.target_night)]
            return {
                **s1, 
                'target_day_img_metas': s2['img_metas'],
                'target_day_img': s2['img'],
